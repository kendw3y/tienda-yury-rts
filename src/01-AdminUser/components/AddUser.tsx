...
export const schema = yup.object({
	...
	correo: yup
		.string()
		.email("El campo debe seguir el patron abc@abc.abc")
...
export const AddUser = ({ isVisible }: AddUserProps) => {
	const {
		register,
		handleSubmit,
		formState: { errors },
	...
	return (
		<div className="flex flex-col items-center justify-center fixed top-0 left-0 right-0 bottom-0 z-50 bg-[#000000be] ">
			<div className="bg-gray-900 rounded-2xl shadow-xl flex flex-col gap-6 px-8 py-6 w-full max-w-3xl ">
				<h1 className="text-3xl font-bold text-center">Agregar</h1>
				<form action="" className="flex flex-col gap-4" onSubmit={onsubmit}>
					...
					<div className="flex justify-end center gap-6 blue items-end">
						<CoustomButton
							handleOnClick={() => {}}
