...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tr>
                <th scope="col" className="p-4">
                    <div className="flex items-center">
                        <input id="checkbox-all-search" type="checkbox" className="w-4 h-4  text-blue-600 bg-gray-100"/>
        ...
        <tbody>
            <tr className="bg-white border-b dark:bg-[#101828]/40 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
