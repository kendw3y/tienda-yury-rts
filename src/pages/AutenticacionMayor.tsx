...
export const AutenticacionMayor = () => {
  return (
    <div className="flex flex-col  items-center justify-center nunito-normal h-screen">
        <div className="w-full grid grid-cols-1 gap-7   max-w-[450px] bg-gray-900   rounded-xl shadow-lg p-10">
            ...
            <form action="" className="grid grid-cols-1 gap-5">
                ...
                <div className="flex justify-between items-center">
                    <button type="submit" className="px-6 py-2  text-blanco rounded-xl bg-[#335BC6] hover:bg-[#335BC6]/60 transition-colors ease-in-out duration-300">
                        Administrar
                    </button>
